...
public class Cores {
	...
	//Reset Color ( Resetar as cores do texto e do fundo de tela)
	public static final String TEXT_RESET = "\u001B[0m";
	
	//Text Color (Aplicar cores no texto)
	...
	//Text Color Bold ( Deixar em Negrito)
	...
	//Reset Text Underline ( Sublinhado )
